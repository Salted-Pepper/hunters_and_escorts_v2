...
E_JAPAN_TERRITORIAL = [Point(148.879, 45.000), Point(143.878, 41.632),
...
H_OUTSIDE_10_DASH = [Point(124.152, 45.000), Point(124.152, 39.734),
                     ...
                     Point(122.87, 25.26), Point(122.43, 24.25),
                     Point(123.48, 22.27), Point(116.41, 17.32),
                     Point(116.28, 15.00), Point(150.000, 15.000),
                     Point(150.000, 45.000)]

I_INSIDE_10_DASH = [Point(120.393, 28.055), Point(122.87, 25.26),
                    Point(122.43, 24.25), Point(123.48, 22.27),
...
N_HOLDING_ZONE = [Point(130.0800, 22.8486),
                  ...
                  Point(131.7491, 20.1507),
                  Point(130.0800, 19.2514),
...
ISHIGAKI = Polygon(name="ishigaki", points=ISHIGAKE_POINTS, color=JAPAN_COLOR)
